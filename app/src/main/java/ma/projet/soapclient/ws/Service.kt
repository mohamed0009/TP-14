...
class Service {
    ...
    // Convertir Double en String pour la sérialisation (ksoap2 rencontre des problèmes avec Double directement)
    // Le serveur doit pouvoir reconvertir la chaîne en nombre
    ...
    fun deleteCompte(id: Long): Boolean {
        ...
        // Utiliser PropertyInfo pour sérialiser correctement un Long
